...
async def handle_start(bot: Client, message: Message):
    ...
    Btn = [
        ...
        [InlineKeyboardButton(text='📰 𝖴ᴘᴅᴀᴛᴇs 🗞️', url='https://t.me/THEDORESONA'), InlineKeyboardButton(text='🤖 𝖡ᴏᴛ 𝐈ɴғᴏ ℹ️', callback_data='about')],
        [InlineKeyboardButton(text='🧑‍💻 𝖮ᴡɴᴇʀ ⌨️', url='https://t.me/KALAKAAR5')]
    ]
